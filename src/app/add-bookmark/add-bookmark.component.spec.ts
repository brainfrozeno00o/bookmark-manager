...
describe('AddBookmarkComponent', () => {
  ...
  it(`Should say 'Add Bookmark' as the title of the card`, () => {
    ...
    expect(el.querySelector('div > mat-card > h2')?.textContent).toContain('Add Bookmark');
  });

  it('The form should be invalid as there are no inputs', waitForAsync(() => {
  ...
  it('The form should be valid as there are now inputs', waitForAsync(() => {
